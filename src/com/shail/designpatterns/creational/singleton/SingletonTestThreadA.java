...
public class SingletonTestThreadA extends Thread{
	...
	public SingletonTestThreadA(final EagerSingletonClass eagerSingletonClass,final StaticBlockSingleton staticBlockSingleton,final LazyInitializationSingleton lazyInitializationSingleton, final ThreadSafeSingleton threadSafeSingleton,final BillPughSingleton billPughSingleton){
